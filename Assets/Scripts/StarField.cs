...
public class StarField : MonoBehaviour {
    ...
    private readonly List<(int[], int[])> constellations = new() {
        ...
        (new int[] { 4467, 4390, 4638, 4621, 4743, 4819, 5132, 5267, 5459, 5231, 5193, 5190, 5440, 5576, 5028, 5288 },
         new int[] { 4467, 4390, 4390, 4638, 4638, 4621, 4621, 4743, 4743, 4819, 4819, 5132, 5132, 5267, 5132, 5459, 5132, 5231, 5231, 5193, 5193, 5190, 5190, 5028, 5190, 5288, 5190, 5440, 5440, 5576 }),
        // Cygnus 
    ...
    void CreateConstellation(int index) {
        ...
        GameObject constellationHolder = new($"Constellation_{index}");
